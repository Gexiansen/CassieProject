...
const context=vm.createContext({
  ...
  caches:{
    ...
    keys:async()=>['cassie-account-v2','cassie-account-v3','cassie-account-v4','cassie-account-v4-20260719','cassie-account-v4-20260719-2'],
...
assert.deepEqual(opened,['cassie-account-v4-20260719-2']);
...
assert.deepEqual(deleted,['cassie-account-v2','cassie-account-v3','cassie-account-v4','cassie-account-v4-20260719']);
